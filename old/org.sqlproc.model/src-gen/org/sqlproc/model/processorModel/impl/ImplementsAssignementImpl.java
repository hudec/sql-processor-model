...
public class ImplementsAssignementImpl extends MinimalEObjectImpl.Container implements ImplementsAssignement
{
    ...
    if (toImplement != null && toImplement.eIsProxy())
    {
      ...
      if (toImplement != oldToImplement)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessorModelPackage.IMPLEMENTS_ASSIGNEMENT__TO_IMPLEMENT, oldToImplement, toImplement));
      }
    }
    return toImplement;
  }
  ...
  public void setToImplement(JvmType newToImplement)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.IMPLEMENTS_ASSIGNEMENT__TO_IMPLEMENT, oldToImplement, toImplement));
  }

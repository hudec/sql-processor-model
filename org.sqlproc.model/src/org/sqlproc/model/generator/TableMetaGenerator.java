...
import org.sqlproc.model.util.Constants;
import org.sqlproc.model.util.Debug;
import org.sqlproc.model.util.SqlFeature;
...
public class TableMetaGenerator extends TablePojoGenerator {
    ...
    TableDefinition getTableDefinition(String tableName) {
        IScope scope = scopeProvider.getScope(artifacts, ProcessorModelPackage.Literals.ARTIFACTS__TABLES);
        Iterable<IEObjectDescription> iterable = scope.getAllElements();
        for (Iterator<IEObjectDescription> iter = iterable.iterator(); iter.hasNext();) {
            IEObjectDescription description = iter.next();
            if (ProcessorModelPackage.Literals.TABLE_DEFINITION.getName().equals(description.getEClass().getName())) {

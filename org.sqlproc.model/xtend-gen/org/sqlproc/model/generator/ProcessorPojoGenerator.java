...
public class ProcessorPojoGenerator {
  ...
  public CharSequence compile(final EnumEntity e) {
    ...
    {
      Integer _sernum = this._processorGeneratorUtils.getSernum(e);
  ...
  public CharSequence compile(final EnumEntity e, final ImportManager im, final EnumProperty ea) {
    ...
    }
    {
      ...
      if (_notEquals) {
        ...
        Integer _sernum_1 = this._processorGeneratorUtils.getSernum(e);
  ...
  public CharSequence compile(final PojoEntity e, final AnnotatedEntity ae, final ImportManager im) {
    ...
    }
    {
      ...
      final Function1<PojoAnnotatedProperty, Boolean> _function = new Function1<PojoAnnotatedProperty, Boolean>() {
        public Boolean apply(final PojoAnnotatedProperty x) {
          ...
          Integer _index = ProcessorPojoGenerator.this._processorGeneratorUtils.getIndex(_feature);
      ...
      for(final PojoAnnotatedProperty f_1 : _filter) {
        ...
        Integer _index = this._processorGeneratorUtils.getIndex(_feature_1);
    ...
    {
      Map<Integer, List<PojoProperty>> _index_1 = this._processorGeneratorUtils.getIndex(e);
      Set<Map.Entry<Integer, List<PojoProperty>>> _entrySet = _index_1.entrySet();
      for(final Map.Entry<Integer, List<PojoProperty>> f_2 : _entrySet) {
        {

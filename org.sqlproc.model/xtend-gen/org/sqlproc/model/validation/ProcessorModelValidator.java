...
public class ProcessorModelValidator extends AbstractProcessorModelValidator {
  ...
  public void checkMetaSqlFtype(final MetaSql metaSql) {
    ...
    if (_not) {
      ...
      this.error(_plus, ProcessorModelPackage.Literals.META_SQL__FTYPE);
    }
  }
  ...
  public void checkColumn(final Column column) {
    ...
    if (_notEquals) {
      IScope _scope = this.scopeProvider.getScope(artifacts, ProcessorModelPackage.Literals.ARTIFACTS__POJO_PACKAGES);
    ...
    if (_notEquals_2) {
      IScope _scope_1 = this.scopeProvider.getScope(artifacts, ProcessorModelPackage.Literals.ARTIFACTS__POJOS);
    ...
    if (_notEquals_5) {
      this.error(("Cannot check result class attribute : " + columnName), ProcessorModelPackage.Literals.COLUMN__COLUMNS);
    }
  }
        ...
        if ((ix > 0)) {
          ...
          if (_equals_1) {
            ...
            if (_equals_3) {
              ...
              if (_equals_5) {
                IScope _scope_2 = this.scopeProvider.getScope(artifacts, ProcessorModelPackage.Literals.ARTIFACTS__POJO_PACKAGES);
                ...
                if (_equals_7) {
                  IScope _scope_3 = this.scopeProvider.getScope(artifacts, ProcessorModelPackage.Literals.ARTIFACTS__POJOS);
                  ...
                  if (_equals_9) {
                    IScope _scope_4 = this.scopeProvider.getScope(artifacts, ProcessorModelPackage.Literals.ARTIFACTS__POJO_PACKAGES);
                    ...
                    if (_equals_11) {
                      IScope _scope_5 = this.scopeProvider.getScope(artifacts, ProcessorModelPackage.Literals.ARTIFACTS__POJOS);
                      ...
                      if (_equals_13) {
                        ...
                        IScope _scope_6 = this.scopeProvider.getScope(artifacts, ProcessorModelPackage.Literals.ARTIFACTS__TABLES);
  ...
  public void checkDatabaseColumn(final DatabaseColumn databaseColumn) {
    ...
    if (_notEquals) {
      IScope _scope = this.scopeProvider.getScope(artifacts, ProcessorModelPackage.Literals.ARTIFACTS__TABLES);
  ...
  public void checkDatabaseTable(final DatabaseTable databaseTable) {
    ...
    final Function1<String, TableDefinition> _function = new Function1<String, TableDefinition>() {
      public TableDefinition apply(final String value) {
        IScope _scope = ProcessorModelValidator.this.scopeProvider.getScope(artifacts, ProcessorModelPackage.Literals.ARTIFACTS__TABLES);
        return Utils.findTable(ProcessorModelValidator.this.qualifiedNameConverter, artifacts, _scope, value);
      }
    };
    ...
    if (_or) {
      this.error(("Cannot find table in DB : " + tableName), ProcessorModelPackage.Literals.DATABASE_TABLE__NAME);
    }
  }

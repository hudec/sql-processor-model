 ...
 *   <li>{@link org.sqlproc.model.processorModel.impl.EnumPropertyImpl#getNative <em>Native</em>}</li>
 *   <li>{@link org.sqlproc.model.processorModel.impl.EnumPropertyImpl#getValue <em>Value</em>}</li>
...
public class EnumPropertyImpl extends MinimalEObjectImpl.Container implements EnumProperty
{
  ...
  {
    return ProcessorModelPackage.Literals.ENUM_PROPERTY;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.ENUM_PROPERTY__NAME, oldName, name));
  }
  ...
  public void setNative(String newNative)
  {
    ...
    native_ = newNative;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.ENUM_PROPERTY__NATIVE, oldNative, native_));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.ENUM_PROPERTY__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.ENUM_PROPERTY__NAME:
        return getName();
      case ProcessorModelPackage.ENUM_PROPERTY__NATIVE:
        return getNative();
      case ProcessorModelPackage.ENUM_PROPERTY__VALUE:
        return getValue();

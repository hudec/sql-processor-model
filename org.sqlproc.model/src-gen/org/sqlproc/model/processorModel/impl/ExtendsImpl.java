 ...
 *   <li>{@link org.sqlproc.model.processorModel.impl.ExtendsImpl#isGenerics <em>Generics</em>}</li>
...
public class ExtendsImpl extends AbstractPojoEntityImpl implements Extends
{
  ...
  public void setGenerics(boolean newGenerics)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.EXTENDS__GENERICS, oldGenerics, generics));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ProcessorModelPackage.EXTENDS__GENERICS:
        return isGenerics();

 ...
 *   <li>{@link org.sqlproc.model.processorModel.impl.DaogenPropertyImpl#getImplPackage <em>Impl Package</em>}</li>
...
public class DaogenPropertyImpl extends MinimalEObjectImpl.Container implements DaogenProperty
{
  ...
  public void setImplPackage(String newImplPackage)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.DAOGEN_PROPERTY__IMPL_PACKAGE, oldImplPackage, implPackage));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ProcessorModelPackage.DAOGEN_PROPERTY__DB_TABLES:
        return getDbTables();
      case ProcessorModelPackage.DAOGEN_PROPERTY__IMPL_PACKAGE:

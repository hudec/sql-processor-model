 ...
 * <ul>
 *   <li>{@link org.sqlproc.model.processorModel.impl.OrdSqlImpl#getSqls <em>Sqls</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrdSqlImpl extends MinimalEObjectImpl.Container implements OrdSql
{
  ...
  {
    return ProcessorModelPackage.Literals.ORD_SQL;
  }
  ...
  public EList<OrdSql2> getSqls()
  {
    if (sqls == null)
    {
      sqls = new EObjectContainmentEList<OrdSql2>(OrdSql2.class, this, ProcessorModelPackage.ORD_SQL__SQLS);
    }
    return sqls;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.ORD_SQL__SQLS:

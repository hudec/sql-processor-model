 ...
 * <ul>
 *   <li>{@link org.sqlproc.model.processorModel.impl.SqlImpl#getSqls <em>Sqls</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SqlImpl extends MinimalEObjectImpl.Container implements Sql
{
  ...
  {
    return ProcessorModelPackage.Literals.SQL;
  }
  ...
  public EList<SqlFragment> getSqls()
  {
    if (sqls == null)
    {
      sqls = new EObjectContainmentEList<SqlFragment>(SqlFragment.class, this, ProcessorModelPackage.SQL__SQLS);
    }
    return sqls;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.SQL__SQLS:

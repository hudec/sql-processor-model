 ...
 * <ul>
 *   <li>{@link org.sqlproc.model.processorModel.impl.MappingColumnImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MappingColumnImpl extends MinimalEObjectImpl.Container implements MappingColumn
{
  ...
  {
    return ProcessorModelPackage.Literals.MAPPING_COLUMN;
  }
  ...
  public EList<ExtendedMappingItem> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<ExtendedMappingItem>(ExtendedMappingItem.class, this, ProcessorModelPackage.MAPPING_COLUMN__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.MAPPING_COLUMN__ITEMS:

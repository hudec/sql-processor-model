 ...
 * <ul>
 *   <li>{@link org.sqlproc.model.processorModel.impl.PojoTypeImpl#getNative <em>Native</em>}</li>
 ...
 *   <li>{@link org.sqlproc.model.processorModel.impl.PojoTypeImpl#getGref <em>Gref</em>}</li>
...
public class PojoTypeImpl extends MinimalEObjectImpl.Container implements PojoType
{
  ...
  public void setNative(String newNative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.POJO_TYPE__NATIVE, oldNative, native_));
  }
  ...
  public PojoEntity getGref()
  {
    if (gref != null && gref.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessorModelPackage.POJO_TYPE__GREF, oldGref, gref));
      }
    }
    return gref;
  }
  ...
  public void setGref(PojoEntity newGref)
  {
    ...
    gref = newGref;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.POJO_TYPE__GREF, oldGref, gref));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.POJO_TYPE__NATIVE:
        return getNative();
      ...
      case ProcessorModelPackage.POJO_TYPE__TYPE:
        ...
        return basicGetType();
      case ProcessorModelPackage.POJO_TYPE__GREF:

...
public class DatabasePropertyImpl extends MinimalEObjectImpl.Container implements DatabaseProperty
{
  ...
  public void setDbUrl(String newDbUrl)
  {
    ...
    dbUrl = newDbUrl;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.DATABASE_PROPERTY__DB_URL, oldDbUrl, dbUrl));
  }
  ...
  public void setDbUsername(String newDbUsername)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.DATABASE_PROPERTY__DB_USERNAME, oldDbUsername, dbUsername));
  }
  ...
  public void setDbPassword(String newDbPassword)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.DATABASE_PROPERTY__DB_PASSWORD, oldDbPassword, dbPassword));
  }
  ...
  public void setDbDriver(String newDbDriver)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.DATABASE_PROPERTY__DB_DRIVER, oldDbDriver, dbDriver));
  }
  ...
  public void setDbExecuteBefore(String newDbExecuteBefore)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.DATABASE_PROPERTY__DB_EXECUTE_BEFORE, oldDbExecuteBefore, dbExecuteBefore));
  }
  ...
  public void setDbExecuteAfter(String newDbExecuteAfter)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.DATABASE_PROPERTY__DB_EXECUTE_AFTER, oldDbExecuteAfter, dbExecuteAfter));
  }
  ...
  public void setDbIndexTypes(String newDbIndexTypes)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.DATABASE_PROPERTY__DB_INDEX_TYPES, oldDbIndexTypes, dbIndexTypes));
  }

 ...
 * <ul>
 *   <li>{@link org.sqlproc.model.processorModel.impl.ColumnImpl#getColumns <em>Columns</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ColumnImpl extends MinimalEObjectImpl.Container implements Column
{
  ...
  {
    return ProcessorModelPackage.Literals.COLUMN;
  }
  ...
  public EList<ExtendedColumn> getColumns()
  {
    if (columns == null)
    {
      columns = new EObjectContainmentEList<ExtendedColumn>(ExtendedColumn.class, this, ProcessorModelPackage.COLUMN__COLUMNS);
    }
    return columns;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorModelPackage.COLUMN__COLUMNS:
